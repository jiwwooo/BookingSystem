	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				...
				<div class="col-md-6">
					<div class="small mb-1">Room No.2</div>
					<h1 class="display-5 fw-bolder">${room2.room_title }</h1>
					<div class="fs-5 mb-5">
						<span>${room2.adult_cost }</span> <span>${room2.room_title }</span>
					</div>
					<p class="lead">${room2.explanation }
					<div class="d-flex">
