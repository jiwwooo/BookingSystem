	...
	<section class="py-5">
		<div class="container px-4 px-lg-5 my-5">
			<div class="row gx-4 gx-lg-5 align-items-center">
				...
				<div class="col-md-6">
					<div class="small mb-1">Room No.4</div>
					<h1 class="display-5 fw-bolder">${room4.room_title }</h1>
					<div class="fs-5 mb-5">
						<span>${room4.adult_cost }</span> <span>${room4.room_title }</span>
					</div>
					<p class="lead">${room4.explanation }
					<div class="d-flex">
			...
			<div
				...
				<div class="col mb-5">
					<div class="card h-100">
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto" href="roomInfoList5">View
								</a>
							</div>
						</div>
					</div>
				...
				<div class="col mb-5">
					<div class="card h-100">
						...
						<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
							<div class="text-center">
								<a class="btn btn-outline-dark mt-auto" href="roomInfoList3">View</a>
							</div>
						</div>
					</div>
				</div>
